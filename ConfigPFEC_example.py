...
def automatic_fixes(d):
    ...
    d["postings"] = [data.Posting(d["account"], d["amount"], None, None, None, None)]

    # general shorting of Postfinance standard phrase
    general = r"KAUF/DIENSTLEISTUNG VOM \d\d.\d\d.\d{4} KARTEN NR. \w{8} "
    ...
    if bool(re.search("coop", d["narration"], re.IGNORECASE)):
        ...
        # Coop gas station
            ...
            if amount_sprit:  # sprit
                d = add_gas_purchase(
                    d, "Expenses:Gasoline", -Amount(Decimal(amount_sprit.groups()[0]), "CHF")
                )
    ...
    # Salary
        ...
        d["postings"] = [
            data.Posting(
                "Income:MyCompany:Salary",
                Amount(Decimal("-5154.12"), "CHF"),
                None,
                None,
                None,
                None,
            ...
            data.Posting(
                "Income:MyCompany:Expenses",
                Amount(Decimal("-61.80"), "CHF"),
                None,
                None,
                None,
                None,
            ...
            data.Posting(
                "Income:MyCompany:S2EmployerContrib",
                Amount(Decimal("-199.24"), "CHF"),
                None,
                None,
                None,
                None,
            ...
            data.Posting(
                "Expenses:LabourCosts:AHV", Amount(Decimal("271.89"), "CHF"), None, None, None, None
            ),
            data.Posting(
                "Expenses:LabourCosts:NBU", Amount(Decimal("56.70"), "CHF"), None, None, None, None
            ),
            data.Posting(
                "Expenses:Taxes:SourceTax", Amount(Decimal("496.56"), "CHF"), None, None, None, None
            ),
            data.Posting(
                "Assets:Bank:Giro:Checking",
                Amount(Decimal("4221.06"), "CHF"),
                None,
                None,
                None,
                None,
            ...
            data.Posting(
                "Assets:Invest:S2:MyCompany:CHF",
                Amount(Decimal("169.70"), "CHF"),
                None,
                None,
                None,
                None,
    ...
    # Rent
    elif bool(re.search("Landlord", d["narration"], re.IGNORECASE)) and (
        d["amount"].number == Decimal(-1200)
    ):
...
if smart:
    apply_hooks(PFEC_, [PredictPostings()])
